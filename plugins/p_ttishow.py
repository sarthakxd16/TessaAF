...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url=f'https://t.me/rb1bots')
            ]]
            reply_markup=InlineKeyboardMarkup(buttons)
            k = await message.reply(
                text='<b>ᴄʜᴀᴛ ᴍᴏᴅᴇ ᴅᴇɴɪᴇᴅ 🧛‍♂️ \n\nɪ ᴀᴍ ʀᴇsᴛʀɪᴄᴛᴇᴅ ᴛᴏ ᴡᴡᴏʀᴋ ʜᴇʀᴇ ! ᴋɪɴᴅʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴏʀ sᴜᴘᴘᴏʀᴛ</b>',
        ...
        await message.reply_text(
            text=f"<b>ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ᴀᴅᴅɪɴɢ ᴍᴇ ᴛᴏ {message.chat.title} ❣️\n\nɪ ᴡɪʟʟ ᴛʀʏ ᴛᴏ ɢɪᴠᴇ ᴇᴠᴇʀʏ ᴍᴏᴠɪᴇ ᴏʀ sᴇʀɪᴇs ᴛᴏ ʏᴏᴜ & ᴡᴏɴᴛ ᴛᴀᴋᴇ ʏᴏᴜ ᴅᴏᴡɴ</b>",
            reply_markup=reply_markup)
    else:
